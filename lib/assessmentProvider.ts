...
Write 3–5 short professional assessment paragraphs, one brief factual strengths block, one brief needs/barriers block, and 2–4 concise plan blocks. Every block must contain exactly one complete sentence and cite only the facts that directly support that sentence. Omit strengths or needs if unsupported. Synthesize, do not repeat the form question-by-question. Aim for 350–500 words total.
