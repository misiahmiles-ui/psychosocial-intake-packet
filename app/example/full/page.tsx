          ...
          <div className="mx-auto flex max-w-7xl flex-col gap-4 px-5 py-4 sm:px-8 lg:flex-row lg:items-center lg:justify-between lg:px-10">
            <div>
              ...
              <h1 className="mt-2 text-2xl font-bold tracking-normal">
                Full fictitious completed workflow example
              </h1>
        ...
        <section className="mx-auto max-w-7xl px-5 py-6 sm:px-8 lg:px-10">
          <div className="mb-5 rounded-lg border border-[#cde7df] bg-mint p-4">
            <p className="flex items-start gap-2 font-bold text-sea">
              ...
              This is the full protected training/sample example.
            </p>
            <p className="mt-2 leading-7 text-[#334642]">
              The participant, provider, company, phone numbers, email
              addresses, and addresses are fictitious. This full example is
              available after access is active and shows the completed
              psychosocial intake workflow, including consents, ROI, home visit,
              discharge planning, and optional authorization sections.
            </p>
          </div>
          ...
          <div className="mb-5 rounded-lg border border-[#d7dfdc] bg-white p-4">
            <p className="flex items-center gap-2 font-bold text-ink">
              ...
              Full example PDF downloads
            </p>
            <p className="mt-2 leading-7 text-[#52645f]">
              Download the full example draft PDF to see editable fields,
              checkbox and radio controls, selected-answer summaries, and
              scoring output. Download the final PDF to see a completed
              wet-signature-ready packet output.
            </p>
          </div>

          <ReviewPacket packet={examplePacket} title="Full Completed Example Review" />
        </section>
      </main>
    </ProtectedAccess>
  );
